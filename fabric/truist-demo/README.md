...
- **Financial crime & AML:** **5,000 AML alerts** raised in the last 24 hours, with **1,007 classified as high severity**; leading alert drivers are **High-Risk Geography (82)**, **Counterparty Concern (78)**, and **Structuring (76)**, indicating elevated compliance and investigative workload.
...
- **Digital engagement:** The bank has **10,000 MAU** and **4,876 DAU**, but **mobile adoption remains at 37.93%**, with similar customer event volumes across mobile, tablet, and web for key activities like Login, BillPay, and Transfers.
